<?php
	...
	if($d_s->isi==0) { $_SESSION['e']=4; header('Location: index.php'); exit(); }
	...
	$mt = !empty($_SESSION['mt']) ? $_SESSION['mt'] : NULL; //mentoring
	$pt = !empty($_SESSION['pt']) ? $_SESSION['pt'] : NULL; //placement test
    ...
    <div class="container">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form action="daftar-santri_proses.php" method="post" data-toggle="validator" role="form">
			  ...
			  <div class="row">
			   <div class="col-md-2"><label for="pt">Placement test / registrasi ulang</label></div>
			   <div class="form-group has-feedback col-md-8">
				<select class="form-control" name="pt" required>
					<option value="1"<?php if($pt == 1) echo " selected"; ?>>Sabtu, 10 September 2016</option>
					<option value="2"<?php if($pt == 2) echo " selected"; ?>>Ahad, 11 September 2016</option>
					<option value="3"<?php if($pt == 3) echo " selected"; ?>>Tidak bisa keduanya</option>
				</select>
				<div class="help-block">Apabila ada perubahan silakan edit profil.</div>
			   </div>
			  </div>
			  <div class="row">
